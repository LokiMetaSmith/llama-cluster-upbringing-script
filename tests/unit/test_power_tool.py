...
def test_set_idle_threshold_for_new_service(mock_file, mock_exists, power_tool):
    ...
    result = power_tool.set_idle_threshold(service_port=8080, idle_seconds=300)
...
def test_set_idle_threshold_for_existing_service(mock_file, mock_exists, power_tool):
    ...
    with patch('builtins.open', m):
        result = power_tool.set_idle_threshold(service_port=8080, idle_seconds=500)
        ...
        assert written_json["monitored_services"]["8080"]["idle_threshold_seconds"] == 500
