...
lb config \
  ...
  --win32-loader false \
  --bootappend-live "boot=live components quiet splash locales=en_US.UTF-8 keyboard-layouts=us live-config.username=pipecatapp live-config.user-password=pipecat live-config.user-fullname=PipecatApp"
