...
- [x] **Simian Open Source Ecosystem Roadmap & Safeguarded Tools:**
  ...
  - [ ] **Codebase Complexity & Similarity Workflow Node (Tier 2):** Add `ComplexityEvaluatorNode` wrapping cyclomatic complexity metrics (`es6-plato`) and structural similarity checking.
  - [ ] **3D Spatial Steering Vector Placement (Tier 2):** Integrate `dedungeon` room partitioning and `desteer.js` steering math into `VRTool.compute_spatial_grid`.
