...
class PolyphonyTool:
    ...
    def get_schema(self) -> dict:
        return {
            "type": "function",
            "function": {
                "name": getattr(self, "name", "polyphonytool"),
                "description": getattr(self, "description", "Tool PolyphonyTool"),
                "parameters": {
                    "type": "object",
                    "properties": {
                        "action": {
                            "type": "string",
                            "description": "The action to perform. Available: get_info"
                        },
                        "kwargs": {
                            "type": "object",
    ...
    def execute(self, action: str, **kwargs):
        if action == "get_info":
            return getattr(self, "get_info")(**kwargs.get("kwargs", kwargs))
        else:
