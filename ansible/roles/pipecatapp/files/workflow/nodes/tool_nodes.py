...
class SystemPromptNode(Node):
    ...
    async def execute(self, context: WorkflowContext):
        # In the refactor, the tools dict will be passed in as a global input.
        ...
        # Expert routing would also be added here in a full implementation.
...
class ToolExecutorNode(Node):
    ...
    async def execute(self, context: WorkflowContext):
        ...
        tool_name, method_name = tool_call_data.get("tool", "").split('.')
