...
Do not remove code that appears redundant without first verifying that it will not cause a feature regression. Some components may have overlapping but in distinct purposes.
