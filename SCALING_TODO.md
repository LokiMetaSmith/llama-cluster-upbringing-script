...
- [x] **Context Injection**
    - [x] Allow Manager to specify "External Specs" to load for a mission.

## Phase 5: Scaling & Swarm
- [x] **Infrastructure Tuning**
    - [x] Verify Nomad job templates allow dynamic scaling.
    - [x] Test with >10 concurrent agents.
- [x] **SwarmTool Upgrade**
